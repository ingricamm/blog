...
export const get_blog_list_category_page = (name,p) => async dispatch => {
    ...
    try{
        const res = await axios.get(`${process.env.REACT_APP_API_URL}/api/blog/category/${name}?p=${p}`, config);
